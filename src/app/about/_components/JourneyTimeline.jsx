        ...
        <div className="space-y-8">
          {experienceTimeline.map((experience) => (
            ...
            >
              ...
              <Card className="flex-1 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2 border-2 border-gray-100">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
                  ...
                  <span className="mt-2 sm:mt-0 px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold w-fit">
                    {experience.year}
                  </span>
                </div>
