    ...
    <section className="px-4 sm:px-6 lg:px-12 xl:px-20 mb-16 sm:mb-20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-gray-800">Story Highlights</h2>
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 px-4">Featured moments that tell the story behind the images</p>
        </div>
